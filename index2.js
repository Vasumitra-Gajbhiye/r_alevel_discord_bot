...
client.once(Events.ClientReady, async () => {
    try {
        ...
        if (!channel) return console.error("❌ Application channel not found.");

        // Clear old bot message if you want (optional)
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                "Welcome! You can apply for certificates here.\n\n" +
                "**Available Certificates:**\n" +
                "• 🟦 Helper Certificate\n" +
                "• 🟩 Writer Certificate\n" +
                "• 🟨 Resource Contributor Certificate\n\n" +
                "Click a button below to submit your application."
            )
            .setColor("#2b2d31");
        ...
        const row = new ActionRowBuilder().addComponents(
            new ButtonBuilder()
                ...
                .setLabel("Apply for Helper")
                .setStyle(ButtonStyle.Primary),

            new ButtonBuilder()
                .setCustomId("apply_writer")
                .setLabel("Apply for Writer")
                .setStyle(ButtonStyle.Success),

            new ButtonBuilder()
                .setCustomId("apply_resource")
                .setLabel("Apply for Resource Contributor")
        ...
        console.error("❌ Error sending application panel:", err);
    }
});
